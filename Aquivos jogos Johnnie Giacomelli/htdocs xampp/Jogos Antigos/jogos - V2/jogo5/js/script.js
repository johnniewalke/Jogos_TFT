(function(){
	var game = new Phaser.Game(800,580,Phaser.AUTO,null,{preload:preload,create:create,update:update});//{}Qual fase);
	...
	function create(){ // Criar elementos dentro do jogo (val, array)
		...
		/////////////////////////////////////////// cupinzeiro
	    sprite2 = game.add.sprite(750, 501, 'cupinzeiro');
