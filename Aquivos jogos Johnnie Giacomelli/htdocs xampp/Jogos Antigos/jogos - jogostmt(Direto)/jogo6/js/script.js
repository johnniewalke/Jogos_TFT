(function(){
	...
	var platforms,player,keys,stars,txtScore,score = 25, letraAtual, galinhaAtual;
	...
	//	galinha3.animations.play('bota');
    	 ...
    	 fimTxt = game.add.text(140, 270, '', { font: '52px Arial', fill: '#000000' });
		botaOvo();
	...
	function scoreGame(player,star){
 
	    if (score == 1){
	         score -= 1;
	         scoreTxt.text = 'Pontos para completar: ' + score;
	         fimTxt.text = 'Parabéns, fim de jogo!'
	     } else if(score >1 ){
	       score -= 1;
	       scoreTxt.text = 'Pontos para completar: ' + score;
	     } else {
